...
export default function Moon() {
    ...
    <Image className="max-lg:scale-90 select-none hover:scale-105 duration-700 ease-out" src="/images/image-moon.png" width={380} height={380} alt="moon"  />
    <div className="flex-col w-[30%]">
        <h4 className="text-9xl my-[4%] max-lg:my-[1%]" >Moon</h4>
