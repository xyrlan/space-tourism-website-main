...
export default function Titan() {
    ...
    return(
        ...
        <Image className="max-lg:scale-90 select-none hover:scale-105 duration-700 ease-out max-md:absolute max-md:-top-[350px] max-md:scale-50 " src="/images/image-titan.png" width={380} height={380} alt="europa"  />
        <div className="w-[30%] max-md:px-5 max-md:text-center max-md:w-[75%]">
