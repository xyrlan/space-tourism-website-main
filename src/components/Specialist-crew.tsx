...
export default function Specialist() {
    return (
        <div className="flex items-center px-[10%] gap-[10%] max-lg:gap-[3%] max-lg:px-[3%] z-10 max-md:flex-col">
            ...
            <Image className="z-10 md:hidden select-none hover:opacity-95 hover:brightness-100 brightness-90 duration-500 mb-4" src="/images/image-mark-shuttleworth.png" width={200} height={200} alt="mark" />
