...
export default function Capsule() {
    return (
        <div className="md:inline-flex items-center md:ml-[5%] relative gap-20 max-lg:gap-5 max-md:justify-center max-md:flex max-md:flex-col max-md:p-4">
            ...
            <Image className=" md:hidden " src="/images/image-space-capsule-landscape.jpg" width={450} height={400} alt="capsula" />
            ...
            <div className="">
                <Image className="max-xl:scale-90 max-md:hidden max-md:opacity-0" src="/images/image-space-capsule-portrait.jpg" width={450} height={400} alt="capsule" />
            </div>
        </div>
